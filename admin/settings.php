...
$insertdata = mysqli_query($con,"INSERT INTO settings(site_name,phone,email,footer_desc,address,city,state,country,pin,header_logo,footer_logo,facebook,twitter,linkedin,instagram,gmail,map)VALUES('$site_name','$phone','$email','$footer_desc','$address','$city','$state','$country','$pin','$header_logo','$footer_logo','$facebook','$twitter','$linkedin','$instagram','$gmail','$map')");
...
move_uploaded_file($tempname, $folder);
move_uploaded_file($tempname2, $folder2);
$insertdata = mysqli_query($con,"UPDATE settings SET site_name='$site_name',phone='$phone',email='$email',footer_desc='$footer_desc',address='$address',city='$city',state='$state',country='$country',pin='$pin',header_logo='$header_logo',footer_logo='$footer_logo',facebook='$facebook',twitter='$twitter',linkedin='$linkedin',instagram='$instagram',gmail='$gmail',map='$map' where id=".$edit."");
        ...
        <div class="col-md-6">
          <div class="card card-outline card-info">
			<div class="card-header">
             ...
             <div class="form-group">
                  <label>Gmail</label>
                 <input name="gmail" value="<?php echo $roww["gmail"]; ?>" type="text" class="form-control" placeholder="URL">
                </div>
            </div>
